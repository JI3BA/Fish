        ...
        <div className="header" id="header">
            <div className="header__container wrapper">
                <nav className="header__navigation">
                    <a href="http://localhost:3000/Fish#gallery" className="header__link">Gallery</a>
                    <a href="http://localhost:3000/Fish#menu" className="header__link">Menu</a>
                    <a href="https://github.com/JI3BA" target="_blank" rel="noreferrer" className="header__link">
                    ...
                    <a href="http://localhost:3000/Fish#recipes" className="header__link">Recipes</a>
                    <a href="http://localhost:3000/Fish#contacts" className="header__link">Contacts</a>
                </nav>
            </div>
        </div>
    )
