...
const initialState: RecipesState = {
    recipes: [
    {
        ...
        picture: salmonSteak,
        time: '40 minutes',
        steps: ['Season salmon on both sides with salt and pepper. In a large skillet over medium-high heat, heat oil and butter. Add salmon and cook until bottom is golden, 5 minutes, then flip. Add garlic, lemon juice, honey, and red pepper flakes. Cook until salmon is cooked through, another 5 minutes, spooning sauce over salmon as it cooks.', 'Garnish with parsley before serving.']
    },
    {
        id: 1,
        name: 'Tuna Steak',
        ...
        picture: tunaSteak,
        time: '30 minutes',
        steps: ['Mix orange juice, soy sauce, olive oil, parsley, lemon juice, garlic, oregano, and pepper together in a large non-reactive dish until well combined. Place tuna steaks in marinade and turn to coat. Cover the dish with plastic wrap and marinate in the refrigerator for at least 30 minutes.',
    ...
    },
    {
        ...
        time: '35 minutes',
        steps: ['In a Cup put the sour cream. Add enough warm boiled water, pour soy sauce. Thoroughly with fork to whisk the mixture.',
            'To the mixture add the breadcrumbs, stir and leave to swell.' +
            ...
            'Fish forcemeat add the egg and soaked breadcrumbs, add the salt and pepper mixture.' +
    ...
    },
    {
        ...
        picture: saltedTrout,
        time: '2 days',
        steps: ['Trout, cleaned of scales and entrails.',
            'Remove the head, tail (do not throw away these parts, prepare the ear), fins, cut the fish in half - lengthwise, remove the bones. Prepare the fillets without skin. Pat them dry with a paper towel. Add salt to each half on both sides. Put most of the salt on the thickened edges.',
            'Put the fish in a plastic bag or a suitable-sized fish dish (dishware). I can stand the fish for a day and eat it, if it seems to you that this time is not enough, increase the salting time to the desired. The fish turns out crispy, delicious, not burdened with other flavors.']
    },
    {
        id: 5,
        ...
        picture: halibutOven,
        time: '30 minutes',
        steps: ['Preheat outdoor grill to medium heat or indoor oven to 400 degrees. Prepare 4 sheets of heavy-duty aluminum foil at least 16" x 12". Season each halibut filet on all sides with salt and pepper then set aside.',
